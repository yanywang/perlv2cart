...
checkapps()
{
   ...
   for singleapp in ${appschoice}; do
       fapp=$(eval echo $app_list|sed -n /\ $singleapp\ /p)
       if [ X"$fapp" == X"" ]; then
          echo "ERROR: $singleapp can't be created!\n"
          return 1
       fi
   done
return 0
...
echo "INFO: ${gbApps} will be created"| tee -a ${log_file}
...
echo '***********************************************' | tee -a ${log_file}
if [ X"$(eval echo $gbApps|sed -n /\ php_app\ /p)" !=  X"" ]; then
...
echo '***********************************************' | tee -a ${log_file}
if [ X"$(eval echo $gbApps|sed -n /\ perl_app\ /p)" !=  X"" ]; then
...
echo '***********************************************' | tee -a ${log_file}
if [ X"$(eval echo $gbApps|sed -n /\ python26_app\ /p)" !=  X"" ]; then
...
echo '***********************************************' | tee -a ${log_file}
if [ X"$(eval echo $gbApps|sed -n /\ python27_app\ /p)" !=  X"" ]; then
...
echo '***********************************************' | tee -a ${log_file}
if [ X"$(eval echo $gbApps|sed -n /\ ruby18_app\ /p)" !=  X"" ]; then
...
echo '***********************************************' | tee -a ${log_file}
if [ X"$(eval echo $gbApps|sed -n /\ ruby19_app\ /p)" !=  X"" ]; then
...
echo '***********************************************' | tee -a ${log_file}
if [ X"$(eval echo $gbApps|sed -n /\ nodejs010_app\ /p)" !=  X"" ]; then
...
echo '***********************************************' | tee -a ${log_file}
if [ X"$(eval echo $gbApps|sed -n /\ jbossews10_app\ /p)" !=  X"" ]; then
...
echo '***********************************************' | tee -a ${log_file}
if [ X"$(eval echo $gbApps|sed -n /\ jbossews20_app\ /p)" !=  X"" ]; then
...
echo '***********************************************' | tee -a ${log_file}
if [ X"$(eval echo $gbApps|sed -n /\ jbosseap_app\ /p)" !=  X"" ]; then
...
echo '***********************************************' | tee -a ${log_file}
if [ X"$(eval echo $gbApps|sed -n /\ diy_app\ /p)" !=  X"" ]; then
...
echo '***********************************************' | tee -a ${log_file}
if [ X"$(eval echo $gbApps|sed -n /\ scalable_php_app\ /p)" !=  X"" ]; then
...
echo '***********************************************' | tee -a ${log_file}
if [ X"$(eval echo $gbApps|sed -n /\ scalable_perl_app\ /p)" !=  X"" ]; then
...
echo '***********************************************' | tee -a ${log_file}
if [ X"$(eval echo $gbApps|sed -n /\ scalable_python26_app\ /p)" !=  X"" ]; then
...
echo '***********************************************' | tee -a ${log_file}
if [ X"$(eval echo $gbApps|sed -n /\ scalable_python27_app\ /p)" !=  X"" ]; then
...
echo '***********************************************' | tee -a ${log_file}
if [ X"$(eval echo $gbApps|sed -n /\ scalable_ruby19_app\ /p)" !=  X"" ]; then
...
echo '***********************************************' | tee -a ${log_file}
if [ X"$(eval echo $gbApps|sed -n /\ scalable_nodejs010_app\ /p)" !=  X"" ]; then
...
echo '***********************************************' | tee -a ${log_file}
if [ X"$(eval echo $gbApps|sed -n /\ scalable_jbossews10_app\ /p)" !=  X"" ]; then
...
echo '***********************************************' | tee -a ${log_file}
if [ X"$(eval echo $gbApps|sed -n /\ scalable_jbossews20_app\ /p)" !=  X"" ]; then
...
echo '***********************************************' | tee -a ${log_file}
if [ X"$(eval echo $gbApps|sed -n /\ scalable_jbosseap_app\ /p)" !=  X"" ]; then
...
echo '***********************************************' | tee -a ${log_file}
if [ X"$(eval echo $gbApps|sed -n /\ scalable_jbosseap_app1\ /p)" !=  X"" ]; then
