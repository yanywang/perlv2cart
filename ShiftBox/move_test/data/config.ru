...
get '/mysql' do
    dbh = Mysql.real_connect("#{ENV['OPENSHIFT_MYSQL_DB_HOST']}","#{ENV['OPENSHIFT_MYSQL_DB_USERNAME']}","#{ENV['OPENSHIFT_MYSQL_DB_PASSWORD']}","#{ENV['OPENSHIFT_APP_NAME']}",port=ENV['OPENSHIFT_MYSQL_DB_PORT'].to_i)
